...
@Component
@EnableScheduling
public class SyncCreateOrderJob implements SchedulingConfigurer {
    private Logger logger = LoggerFactory.getLogger(SyncCreateOrderJob.class);
